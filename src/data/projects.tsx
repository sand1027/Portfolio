...
const projects: Project[] = [
  ...
  // },
  {
    ...
    title: "Shairoz Consultancy",
    src: "/assets/projects-screenshots/shairoz/sh1.png",
    screenshots: ["01.jpeg", "03.png"],
    live: "https://shairozconsultancy.com/",

    skills: {
      frontend: [PROJECT_SKILLS.react, PROJECT_SKILLS.html, PROJECT_SKILLS.css],
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Shairoz Architectural Consultancy is a dynamic team of architectural
            professionals dedicated to transforming visions into reality.
            Founded by three passionate architects, we specialize in providing
            architectural design services that include 2D and 3D drafting,
            visualization, and AI-enhanced renderings. Based in Bengaluru with
            ambitions of global expansion, we are committed to delivering
            exceptional service and innovative solutions for architects,
            engineers, designers, and real estate developers.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <SlideShow
            images={[
              `${BASE_PATH}/shairoz/sh1.png`,
              `${BASE_PATH}/shairoz/sh2.png`,
              `${BASE_PATH}/shairoz/sh3.png`,
            ]}
          />
        </div>
      );
  ...
  },
  {
    ...
    category: "Full stack",
    title: "Tres Vibq",
    src: "/assets/projects-screenshots/tres/tres1.png",
    screenshots: [
      "01.png",
      "02.png",
      "03.png",
    ...
    live: "http://tresvinq.com/",
    github: "https://github.com/sand1027/TresVinq",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            TRESVINQ Kleanir Private Limited is a leading solution provider in
            Cleanroom, Air Duct, SS Furniture, Electrical enclosures and all
            related to clean room solution. TRESVINQ is your trusted partner for
            cutting-edge clean room solutions. Our state-of-the-art
            manufacturing processes ensure top-quality products that meet
            industry standards. Explore our range: Offering an all-inclusive,
            turnkey service, we are experts in planning, designing, directly
            manufacturing, validating and installing Clean Rooms. Choosing
            Galvani means choosing a partner who understands your needs and can
            provide you with effective, customized, certified and ready-to-use
            solutions.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/tres/tres1.png`,
              `${BASE_PATH}/tres/tres2.png`,
              `${BASE_PATH}/tres/tres3.png`,
            ]}
          />
        </div>
      );
  ...
  },
  {
    ...
    id: "pixelatedigisolutions",
    category: "Web Development",
    title: "Pixelate Digi Solutions",
    src: "/assets/projects-screenshots/pixelatedigi/pixelate1.png",
    screenshots: ["01.png", "02.png", "03.png", "04.png", "05.png"],
    live: "https://www.pixelatedigi.com/",
    github: "https://github.com/sand1027/PixelateDigiSolutions",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.next,
      ...
      return (
        <div>
          <TypographyP className="font-mono">
            ...
            <strong>Pixelate Digi Solutions</strong> — a digital marketing
            agency offering branding, design, and growth solutions. This
            responsive web platform showcases the agency’s services, team, and
            project portfolio through an engaging user experience. As a
            full-stack developer, I handled everything from front-end UI/UX
            using <strong>Figma, Next.js, Tailwind CSS</strong> to back-end
            integration and database planning. I also optimized the site for{" "}
            <strong>SEO</strong> and performance to improve search visibility
            and user engagement. The project reflects modern design principles,
            dynamic content flow, and scalable code architecture.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/pixelatedigi/pixelate1.png`,
              `${BASE_PATH}/pixelatedigi/pixel2.png`,
              `${BASE_PATH}/pixelatedigi/pixel3.png`,
            ]}
          />
        </div>
      );
