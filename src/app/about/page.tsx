        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Sandeep, a Masters Degree in Computer
              Application with 1.5 year experience in Devlopment, SEO, UI/UX
              Designs and Database management with hands-on experience in
              deploying & automating workflows, and collaborating with foreign
              clients. Strong analytical skills,effective communication, and a
